...
def draw_screen():
    #screen outline shapes for background
    ...
    pause_btn.draw()
    screen.blit(header_font.render(f'Score: {score}', True, 'black'), (250, 10))
    screen.blit(header_font.render(f'Best: {high_score}', True, 'black'), (550, 10))
    screen.blit(header_font.render(f'Lives: {lives}', True, 'black'), (10, 10))
